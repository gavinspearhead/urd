 ...
 * $Id: defaults.php 2885 2013-08-03 22:07:36Z gavinspearhead@gmail.com $
 */
...
function get_default_config()
{
    ...
    $prefArray_root['auto_download'] = 1;
    ...
    $prefArray_root['spots_whitelist']          = 'http://jij.haatmij.nl/spotnet/whitelist.txt'; //black list with spotterIds known for spamming etc

    $prefArray_root['settype_' . SETTYPE_UNKNOWN ]      = '%T %C %P %n';
    $prefArray_root['settype_' . SETTYPE_MOVIE ]        = '%T %C %P %n %(y) %m %a %l %s %[x] %N ';
    $prefArray_root['settype_' . SETTYPE_DOCUMENTARY ]  = '%T %C %P %n %(y) %m %a %l %s %[x] %N ';
    $prefArray_root['settype_' . SETTYPE_ALBUM ]        = '%T %C %P %n %(y) %f %g %N';
    $prefArray_root['settype_' . SETTYPE_TVSERIES ]     = '%T %C %P %n %e %m %a %[x] %N ';
    $prefArray_root['settype_' . SETTYPE_SOFTWARE ]     = '%T %C %P %n %(o) %N';
    $prefArray_root['settype_' . SETTYPE_GAME ]         = '%T %C %P %n %(o) %N';
    $prefArray_root['settype_' . SETTYPE_EBOOK ]        = '%T %C %P %n - %A %(y) %f %g ';
    $prefArray_root['settype_' . SETTYPE_IMAGE ]        = '%T %C %P %n %f %g %[x] %N';
    $prefArray_root['settype_' . SETTYPE_TVSHOW ]       = '%T %C %P %e %n %m %a %[x] %N ';
    $prefArray_root['settype_' . SETTYPE_OTHER ]        = '%T %C %P %n';
    ...
    $prefArray_root['poster_blacklist'] = '';
