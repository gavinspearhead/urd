...
class ADODB_pdo extends ADOConnection {
    ...
    function _create_function($fn_name, $fn, $num) 
    {
        return $this->_connectionID->sqliteCreateFunction($fn_name, $fn, $num); // needed only for sqlite but that is the only pdo we use anyway
    }
