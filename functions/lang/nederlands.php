...
$LN['pref_url_redirector']          = 'Gebruik een URL redirector';
$LN['pref_url_redirector_msg']      = 'Gebruik een URL redirector (bijv. om lekken van referrer informatie te voorkomen, laat leeg om direct te linken)';
...
$LN['config_download_comment_avatar']       = 'Download avatars voor spot commententaren';
$LN['config_download_comment_avatar_msg']   = 'Download avatars voor spot commentaren (Noot: Deze kunnen groot zijn en de database behoorlijk opblazen)';
...
$LN['pref_spot_view_msg'] = 'De weergavestijl die gebruikt wordt voor het spotsoverzicht';
$LN['spot_view_modern']    = 'Modern';
$LN['spot_view_classic']    = 'Klassiek';
...
$LN['config_drop_random']       = 'Verwijder sets met willekeurig lijkende naam';
...
$LN['config_period_getspots_msg']	= 'Plan het laden van spots';
$LN['config_period_expirespots']	    = 'Schoon spots op';
$LN['config_period_expirespots_msg']	= 'Plan het opschonen van oude spots';
...
$LN['config_period_cu']             = 'Periode voor inactieve gebruikers';
$LN['config_period_cu_msg']         = 'Periode voor inactieve, non-admin gebruikers waarna ze worden verwijderd in dagen';
$LN['config_users_clean_age_msg']   = 'Clean inactive, non-admin users after a period of inactivity';
$LN['config_users_clean_age']       = 'Verwijder inactieve gebruikers';
$LN['config_users_clean_age_msg']   = 'Verwijder inactieve non-admin gebruikers na een periode van afwezigheid (in dagen)';
$LN['config_socket_timeout']        = 'Socket timeout';
$LN['config_connection_timeout']	    = 'Verbindingstimeout naar de usenet server';
$LN['config_connection_timeout_msg']	= 'De tijd die een usenet server niet wordt gebruikt wanneer de verbinding een timeout krijgt (0 is niet uitschakelen - gebruik dit zorgvuldig want dit kan de usenet server overbelasten)';
$LN['config_urdd_connection_timeout']       = 'URDD verbindingstimeout';
...
$LN['config_drop_random_msg']          = 'Verwijder sets met een naam die willekeurig lijkt';
...
$LN['spots_similar']     = 'Vergelijkbaar';
$LN['spots_all']         = 'Alles';
