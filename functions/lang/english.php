...
$LN['pref_default_group_msg']   = 'Default group to select in the groups page';
...
$LN['pref_buttons']          = 'Search options';
...
$LN['config_download_comment_avatar']   = 'Download avatars for spot comments';
$LN['config_download_comment_avatar_msg']   = 'Download avatars for spot comments (note these may be big and bloat the database)';
...
$LN['error_filetoolargetodl']       = 'File too large to download';
...
$LN['config_period_expirespots']	    = 'Expire spots';
$LN['config_period_expirespots_msg']	= 'Schedule when old spots will be expired';
...
$LN['config_maxfilesize']   = 'Maximum file size to view in viewfiles';
$LN['config_maxpreviewsize']= 'Maximum file size to preview';
...
$LN['config_maxfilesize_msg']           = 'The maximum file size to view in viewfiles in kB (0 for no limit)';
$LN['config_maxpreviewsize_msg']        = 'The maximum file size to preview in kB (0 for no limit)';
...
$LN['settype'][urd_extsetinfo::SETTYPE_UNKNOWN]     = $LN['config_formatstring'] . ' Unknown';
$LN['settype'][urd_extsetinfo::SETTYPE_MOVIE]       = $LN['config_formatstring'] . ' Movie';
...
$LN['settype'][urd_extsetinfo::SETTYPE_TVSERIES]    = $LN['config_formatstring'] . ' TV series';
$LN['settype'][urd_extsetinfo::SETTYPE_EBOOK]       = $LN['config_formatstring'] . ' Ebook';
$LN['settype'][urd_extsetinfo::SETTYPE_GAME]        = $LN['config_formatstring'] . ' Game';
$LN['settype'][urd_extsetinfo::SETTYPE_TVSHOW]      = $LN['config_formatstring'] . ' TV Show';
$LN['settype'][urd_extsetinfo::SETTYPE_DOCUMENTARY] = $LN['config_formatstring'] . ' Documentary';
$LN['settype'][urd_extsetinfo::SETTYPE_OTHER]       = $LN['config_formatstring'] . ' Other';
...
$LN['settype_msg'][urd_extsetinfo::SETTYPE_OTHER]       = $LN['settype_syntax'] . 'Other settype: <br/>%n: name<br/>%t: set type<br/>%T: type dependent icon<br/>%N: notes<br/>%P: password protected<br/>%C: copyrighted material';
