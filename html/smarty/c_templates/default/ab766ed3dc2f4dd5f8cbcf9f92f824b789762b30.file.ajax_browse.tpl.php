<?php /* Smarty version Smarty-3.1.14, created on 2013-08-06 00:04:36
         compiled from "/var/www/html/urd/branches/devel/html/smarty/templates/default/ajax_browse.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162201343252002174440618-88168259%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ab766ed3dc2f4dd5f8cbcf9f92f824b789762b30' => 
    array (
      0 => '/var/www/html/urd/branches/devel/html/smarty/templates/default/ajax_browse.tpl',
      1 => 1373151380,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162201343252002174440618-88168259',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_520021747945a5_18117535',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_520021747945a5_18117535')) {function content_520021747945a5_18117535($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/urd/branches/devel/functions/libs/smarty/libs/plugins/modifier.replace.php';
?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', 'unmark_int_all', null); ob_start(); ?><div class="floatright"><?php if ($_smarty_tpl->tpl_vars['killflag']->value) {?><div class="inline iconsizeplus killicon buttonlike" onclick="javascript:Whichbutton('unmark_kill_all', event);" <?php echo smarty_function_urd_popup(array('type'=>"small",'text'=>$_smarty_tpl->tpl_vars['LN_browse_resurrectset']->value),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['sort']->value['order']=="complete") {?> <?php if ($_smarty_tpl->tpl_vars['sort']->value['direction']=='desc') {?><?php $_smarty_tpl->tpl_vars['complete_sort'] = new Smarty_variable($_smarty_tpl->tpl_vars['up']->value, null, 0);?> <?php } else { ?><?php $_smarty_tpl->tpl_vars['complete_sort'] = new Smarty_variable($_smarty_tpl->tpl_vars['down']->value, null, 0);?> <?php }?> <?php } else { ?><?php $_smarty_tpl->tpl_vars['complete_sort'] = new Smarty_variable('', null, 0);?> <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['sort']->value['order']=="date") {?> <?php if ($_smarty_tpl->tpl_vars['sort']->value['direction']=='desc') {?><?php $_smarty_tpl->tpl_vars['stamp_sort'] = new Smarty_variable($_smarty_tpl->tpl_vars['up']->value, null, 0);?> <?php } else { ?><?php $_smarty_tpl->tpl_vars['stamp_sort'] = new Smarty_variable($_smarty_tpl->tpl_vars['down']->value, null, 0);?> <?php }?> <?php } else { ?><?php $_smarty_tpl->tpl_vars['stamp_sort'] = new Smarty_variable('', null, 0);?> <?php }?>
...
<th class="fixwidth2a nowrap buttonlike head right" onclick="javascript:change_sort_order('date');"><?php echo $_smarty_tpl->tpl_vars['LN_browse_age']->value;?>
...
<th class="fixwidth1 buttonlike head" onclick="javascript:change_sort_order('complete');"><?php echo $_smarty_tpl->tpl_vars['LN_browse_percent']->value;?>
 </th>
...
<th class="nowrap fixwidth4 head round_right"><?php echo $_smarty_tpl->tpl_vars['unmark_int_all']->value;?>
</th>
</tr>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
...
', 'group', event);return false;"></div><input type="hidden" name="setdata[]" id="set_<?php echo $_smarty_tpl->tpl_vars['set']->value['sid'];?>
...
<?php $_smarty_tpl->tpl_vars['complete'] = new Smarty_variable("light_yellow", null, 0);?>
<?php $_smarty_tpl->tpl_vars['completion'] = new Smarty_variable($_smarty_tpl->tpl_vars['set']->value['complete'], null, 0);?>
<?php $_smarty_tpl->tpl_vars['completion'] = new Smarty_variable(((string) $_smarty_tpl->tpl_vars['completion']->value)."%", null, 0);?>

<?php if ($_smarty_tpl->tpl_vars['set']->value['complete']<120) {?><?php $_smarty_tpl->tpl_vars['complete'] = new Smarty_variable("light_green", null, 0);?><?php }?>
<?php if ($_smarty_tpl->tpl_vars['set']->value['complete']<100) {?><?php $_smarty_tpl->tpl_vars['complete'] = new Smarty_variable("light_orange", null, 0);?><?php }?>
<?php if ($_smarty_tpl->tpl_vars['set']->value['complete']<90) {?><?php $_smarty_tpl->tpl_vars['complete'] = new Smarty_variable("light_red", null, 0);?><?php }?>
<?php if ($_smarty_tpl->tpl_vars['set']->value['complete']==-1) {?><?php $_smarty_tpl->tpl_vars['complete'] = new Smarty_variable("light_off", null, 0);?><?php $_smarty_tpl->tpl_vars['completion'] = new Smarty_variable('Completion unknown', null, 0);?><?php }?>
...
', <?php echo $_smarty_tpl->tpl_vars['USERSETTYPE_GROUP']->value;?>
...
<?php if ($_smarty_tpl->tpl_vars['rating']->value=='') {?><?php $_smarty_tpl->tpl_vars['imdbpic'] = new Smarty_variable("followicon", null, 0);?><?php }?>
	...
	<td class="fixwidth1"> <div class="<?php echo $_smarty_tpl->tpl_vars['complete']->value;?>
 iconsize noborder" <?php echo smarty_function_urd_popup(array('type'=>"small",'text'=>((string) $_smarty_tpl->tpl_vars['completion']->value)),$_smarty_tpl);?>
></div></td>
    <td class="fixwidth1">
    <?php if ($_smarty_tpl->tpl_vars['set']->value['imdblink']!='') {?>
    <div class="inline iconsize <?php echo $_smarty_tpl->tpl_vars['imdbpic']->value;?>
...
', 'wipe', <?php echo $_smarty_tpl->tpl_vars['USERSETTYPE_GROUP']->value;?>
...
', 'interesting', <?php echo $_smarty_tpl->tpl_vars['USERSETTYPE_GROUP']->value;?>
