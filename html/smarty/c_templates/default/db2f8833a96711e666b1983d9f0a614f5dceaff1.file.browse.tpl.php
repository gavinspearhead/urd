<?php /* Smarty version Smarty-3.1.14, created on 2013-08-24 00:05:08
         compiled from "/var/www/html/urd/branches/devel/html/smarty/templates/default/browse.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78883152152002172a873f6-74326698%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db2f8833a96711e666b1983d9f0a614f5dceaff1' => 
    array (
      0 => '/var/www/html/urd/branches/devel/html/smarty/templates/default/browse.tpl',
      1 => 1376777873,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '78883152152002172a873f6-74326698',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52002172c41431_26653291',
  'variables' => 
  array (
    'title' => 0,
    'rssurl' => 0,
...
<?php if ($_valid && !is_callable('content_52002172c41431_26653291')) {function content_52002172c41431_26653291($_smarty_tpl) {?>
...
" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['shortname'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
<?php } ?>
</div>
...
" id="searchorder"/>
 ...
 onclick='javascript:select_next("select_groupid",-1);'/>&nbsp;
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
		...
		<option <?php if ($_smarty_tpl->tpl_vars['current']->value==$_smarty_tpl->tpl_vars['groupID']->value&&$_smarty_tpl->tpl_vars['groupID']->value!=0) {?>selected="selected"<?php }?> value="<?php echo $_smarty_tpl->tpl_vars['item']->value['type'];?>
_<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
">
...
" class="submitsmall" onclick="javascript:clean_search('search');load_sets( { 'offset':'0', 'setid':'', 'category':'' } ); return false;" />
&nbsp;
&nbsp;
&nbsp;
...
:</td>
<td><input type="text" id="mincomplete" name="mincomplete" size="6" value="<?php echo $_smarty_tpl->tpl_vars['mincomplete']->value;?>
"/></td> 
<td><div id="setcomplete" style="width:100px;"></div></td>
<td><input type="text" id="maxcomplete" name="maxcomplete" size="6" value="<?php echo $_smarty_tpl->tpl_vars['maxcomplete']->value;?>
"/></td>
</tr>
...
" class="submitsmall" onclick='javascript:clear_form("searchform");'/></td>
</tr>
...
"/>
<input type="hidden" name="group_id" id="group_id" value="<?php echo $_smarty_tpl->tpl_vars['groupID']->value;?>
"/>
...
, "#setrating", "#minrating", "#maxrating");
   init_slider(<?php echo $_smarty_tpl->tpl_vars['mincompletelimit']->value;?>
, <?php echo $_smarty_tpl->tpl_vars['maxcompletelimit']->value;?>
, "#setcomplete", "#mincomplete", "#maxcomplete");

    <?php if ($_smarty_tpl->tpl_vars['groupID']->value!='') {?>
        load_sets( { 'next':'<?php echo $_smarty_tpl->tpl_vars['groupID']->value;?>
' } );
    <?php } else { ?>
        load_sets();
    <?php }?>
