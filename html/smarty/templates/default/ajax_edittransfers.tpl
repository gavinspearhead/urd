 ...
 * $Id: ajax_edittransfers.tpl 2925 2013-09-10 22:48:12Z gavinspearhead@gmail.com $
 *}
...
<br/>
<input type="hidden" name="dlid" id="dlid" value="{$id}" />
...
<span id="dl_dir_span">
    ...
    {if $dldir_noedit != 1}<div class="foldericon iconsize floatleft" onclick="toggle_hide('dir_select_span', 'hidden'); toggle_hide('dl_dir_span', 'hidden');"></div>{/if}
</span>
